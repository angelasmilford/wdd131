...
const newCount = parseInt(reviewCount) + 1;
localStorage.setItem('reviewCount', newCount);

const counterDiv = document.getElementById('review-counter');
counterDiv.textContent = `You have submitted ${newCount} reviews.`;